...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Residual MLP baseline on extracted feature vectors.")
    parser.add_argument("--data-root", type=Path, default=Path("dataset"))
    parser.add_argument("--output-dir", type=Path, default=Path("Residual_MLP/residual_mlp_runs"))
    ...
    checkpoint_path = args.output_dir / "residual_mlp_best.pt"
    ...
    print(f"Hidden dim: {config.hidden_dim} | Residual blocks: {config.num_blocks}")
