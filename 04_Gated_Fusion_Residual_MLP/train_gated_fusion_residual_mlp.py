...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a Gated Fusion Residual MLP on feature groups.")
    parser.add_argument("--data-root", type=Path, default=Path("dataset"))
    parser.add_argument("--output-dir", type=Path, default=Path("Gated_Fusion_Residual_MLP/runs"))
    parser.add_argument("--epochs", type=int, default=50)
    parser.add_argument("--batch-size", type=int, default=256)
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--weight-decay", type=float, default=1e-4)
    parser.add_argument("--group-embed-dim", type=int, default=128)
    ...
    checkpoint_path = args.output_dir / "gated_fusion_residual_mlp_best.pt"
